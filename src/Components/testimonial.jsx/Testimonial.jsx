...
const Testimonial = () => {
    return (
        ...
        //             {/* Heading  */}
        //             <h1 className=' text-center text-3xl font-bold text-bg-black' >Testimonial</h1>
        //             {/* para  */}
        //             <h2 className=' text-center text-2xl font-semibold mb-10' >What our <span className=' text-black'>customers</span> are saying</h2>

        //             <div className="flex flex-wrap -m-4">
        //                 {/* Testimonial 1 */}
        //                 <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
        //                     <div className="h-full text-center">
        //                         <img alt="testimonial" className="w-20 h-20 mb-8 object-cover object-center rounded-full inline-block border-2 border-gray-200 bg-gray-600-100" src="https://avatars.githubusercontent.com/u/125145128?v=4" />
        //                         <p className="leading-relaxed">Edison bulb retro cloud bread echo park, helvetica stumptown taiyaki taxidermy 90's cronut +1 kinfolk. Single-origin coffee ennui shaman taiyaki vape DIY tote bag drinking vinegar cronut adaptogen squid fanny pack vaporware.</p>
        //                         <span className="inline-block h-1 w-10 rounded bg-gray-600 mt-6 mb-4" />
        //                         <h2 className="text-gray-900 font-medium title-font tracking-wider text-sm uppercase">Lalit Malviya</h2>
        ...
        //                 <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
        //                     <div className="h-full text-center">
        //                         <img alt="testimonial" className="w-20 h-20 mb-8 object-cover object-center rounded-full inline-block border-2 border-gray-200 bg-gray-600-100" src="https://avatars.githubusercontent.com/u/118448246?v=4" />
        //                         <p className="leading-relaxed">Edison bulb retro cloud bread echo park, helvetica stumptown taiyaki taxidermy 90's cronut +1 kinfolk. Single-origin coffee ennui shaman taiyaki vape DIY tote bag drinking vinegar cronut adaptogen squid fanny pack vaporware.</p>
        //                         <span className="inline-block h-1 w-10 rounded bg-gray-600 mt-6 mb-4" />
        //                         <h2 className="text-gray-900 font-medium title-font tracking-wider text-sm uppercase">Mukesh Choudhary</h2>
        ...
        //                     <div className="h-full text-center">
        //                         <img alt="testimonial" className="w-20 h-20 mb-8 object-cover object-center rounded-full inline-block border-2 border-gray-200 bg-gray-600-100" src="https://firebasestorage.googleapis.com/v0/b/devknus-official-database.appspot.com/o/images%2FScreenshot%202023-07-07%20at%202.20.32%20PM-modified.png?alt=media&token=324ddd80-2b40-422c-9f1c-1c1fa34943fa" />
        //                         <p className="leading-relaxed">Edison bulb retro cloud bread echo park, helvetica stumptown taiyaki taxidermy 90's cronut +1 kinfolk. Single-origin coffee ennui shaman taiyaki vape DIY tote bag drinking vinegar cronut adaptogen squid fanny pack vaporware.</p>
        //                         <span className="inline-block h-1 w-10 rounded bg-gray-600 mt-6 mb-4" />
        //                         <h2 className="text-gray-900 font-medium title-font tracking-wider text-sm uppercase">Abhay Singh</h2>
        ...
        //     </section>
        // </div>
        <section className="py-12 bg-gray-50 sm:py-16 lg:py-20 z-0">
    <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="flex flex-col items-center">
            <div className="text-center">
                ...
                <h2 className="mt-4 text-3xl font-bold text-gray-900 sm:text-4xl xl:text-5xl font-pj">Our happy Customer say about us</h2>
            </div>
