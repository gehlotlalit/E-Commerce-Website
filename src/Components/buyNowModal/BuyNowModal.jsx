    ...
    return (
        <>
            <Button
                type="button"
                onClick={handleOpen}
                className="w-full px-4 py-3 text-center text-gray-100 bg-black border border-transparent dark:border-gray-700 hover:border-gray-500 hover:text-pink-700 hover:bg-black-100 rounded-xl"
            >
                Buy now
            </Button>
