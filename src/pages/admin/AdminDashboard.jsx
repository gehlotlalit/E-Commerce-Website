        ...
        <div className=''>
            ...
            <div className="px-5">
                ...
                <div className="mid mb-5">
                    {/* main  */}
                    <div className=" bg-gray-300 py-5 rounded-xl border border-gray-500">
                        {/* image  */}
                    ...
                    <Tabs>
                        <TabList className="flex flex-wrap -m-4 text-center justify-center">
                            ...
                            <Tab className="p-4 md:w-1/3 sm:w-1/2 w-full cursor-pointer">
                                <div className=" border bg-gradient-to-br from-[#4a4949] via-[#7a7a7a] to-[#d7d0d0] hover:bg-white border-gray-500 px-4 py-3 rounded-xl" >
                                    ...
                                    <p className=" text--500  font-bold" >Total Products</p>
                                </div>
                            </Tab>
